...
data_attention <- data_complete %>%
  filter(attention_check_1 == "pass" & attention_check_2 == 6 & attention_check_3 > 1)
...
data_accuracy <- sum(data_complete$accuracy < 0.60)

print(paste("Excluded for failing filler questions:", data_accuracy))
print(paste("Remaining participants:", n_distinct(data_complete$subject_id))) ##TO DO
